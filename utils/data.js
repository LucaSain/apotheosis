...
export const data = [
    ...
    },
    {
        ...
        position: [
            -1.4210064784627128, -3.4399917282865906, 1.4653318728147682,
        ].map((x) => scale * x),
        color: "white",
        image: "/pitagora.png",
        to: [
        ...
        quote: "Structura lumii trebuie sa fie inteleasa cu ajutorul numerelor",
        time: -570,
    },
    {
        id: "Lao-Tzi",
        ...
        color: "yellow",
        image: "/laotzi.png",
        position: [-0.883892675669064, -3.3155176760308507, 2.0557422693094503].map(
            (x) => x * scale
        ),
        to: ["Mo-Tzi", "Wang Chong"],
        quote:
            "Omul urmeaza legile pamantului,\npamantul pe cele ale cerului, cerul urmeaza calea,\n care este completa in sine.",
        time: -570,
    },
    {
        id: "Confucius",
        ...
        color: "yellow",
        image: "/confucius.png",
        position: [-1.1704656865391294, -2.5026789991240603, 2.892508928936586].map(
            (x) => x * scale
        ),
        to: [
            "Mo-Tzi",
        ...
        quote:
            "Exista oare vreun cuvant, a intrebat Tzu-Kung, care ar putea fi adoptat ca regula de conduita pentru toata viata\n Nu este oare Omenia acel cuvant? Nu face altora ce tie nu ti-ar placea.",
        time: -551,
    },
    {
        id: "Heraclit",
        current: "Social Contract Theory",
        color: "white",
        image: "/heraclit.png",
        position: [
            -0.7076709935792344, -3.5603002922603473, 1.6803165159509281,
        ].map((x) => x * scale),
        to: ["Aristotel", "Platon", "Socrate", "Zenon Din Citium", "Heidegger"],
        quote:
            "Ca lucru unic si unitar exista in noi atat viata, cat si moarte, veghe si somn, tinerete si batranete, pentru ca primele, schimbandu-se au devenit ultimele, iar cand ultimele se vor schimba, vor deveni primele.",
        time: -535,
    },
    {
        id: "Parmenide",
        ...
        image: "/parmenide.png",
        position: [
            0.11537897291485183, -3.5045893772019663, 1.9247184183179236,
        ].map((x) => x * scale),
        to: [
            "Platon",
            "Socrate",
        ...
        quote: "Simturile ne amagesct, dar ratiunea dezvaluie adevarul",
        time: -510,
    },
    {
        id: "Zenon din Eleea",
        current: "German Idealism",
        color: "white",
        image: "/zenondineleea.png",
        position: [0.3833950915023742, -3.694873900201948, 1.4835481338393888].map(
            (x) => x * scale
        ),
        to: ["Platon", , "Plotin", "Heidegger"],
        quote:
            "Schimbarea si miscarea, spatiul si timpul sunt toate in mintea noastra",
        time: -490,
    },
    {
        id: "Mo-Tzi",
        ...
        color: "yellow",
        image: "/motzi.png",
        position: [0.7413285354428506, -3.6714396950798225, 1.403909743512858].map(
            (x) => x * scale
        ),
        to: ["Mencius"],
        quote:
            "Daca un om fura un porc se numeste greseala; dar daca se fura un stat se numeste dreptate.",
        time: -479,
    },

    {
        id: "Socrate",
        current: "Scholasticism",
        color: "white",
        image: "/socrate.png",
        position: [-0.6241339570359158, -3.1411355709904423, 2.396606794685611].map(
            (x) => x * scale
        ),
        to: ["Platon"],
        quote: "Stiu ca nu știu nimic, și nici măcar asta nu știu.",
        time: -470,
    },

    {
        ...
        color: "white",
        image: "/platon.png",
        position: [-0.761718912732686, -3.7988878648354545, 0.9941002406152284].map(
            (x) => x * scale
        ),
        to: [
            "Aristotel",
        ...
        quote:
            "Filozofia este singura cale spre cunoaşterea adevărată - cunoaşterea Formelor -, aşadar fflozoful ar trebui să conducă statul.",
        time: -428,
    },
    ...
    },
    {
        ...
        color: "yellow",
        image: "/mencius.png",
        position: [-1.080705958185937, -2.7471577585368276, 2.699110757574118].map(
            (x) => x * scale
        ),
        to: ["Zhu Xi"],
        quote:
            "Toti cei care vorbesc despre naturile lucrurilor nu dispun, de fapt, decat de fenomenele lor pe care sa-si bazeze rationamentul, iar valoarea unui fenomen consta in aceea ca este natural.",
        time: -371,
    },
    {
        id: "Epicur",
        ...
        image: "/epicur.png",
        position: [
            -0.24860844795087864, -2.7671700977531932, 2.8776663270275167,
        ].map((x) => x * scale),
        to: ["Lucretius", "Gassendi", "Bentham"],
        quote:
            "Cand spunem ca placerea este scopul, nu ne referim la placerile desfranatilor ci la eliberarea corpului de durere si a mintii de tulburare.",
        time: -341,
    },
    ...
    },
    {
        ...
        image: "/plotin.png",
        position: [
            -1.0273304439332354, -2.9375255416338653, 2.5130729896317394,
        ].map((x) => x * scale),
        to: [
            "Augustin",
            "Hypatia",
    ...
    },
    {
        ...
        image: "/augustin.png",
        position: [
            -0.03405233814846316, -3.4898889654086327, 1.9543580652955292,
        ].map((x) => x * scale),
        to: [
            "Boethius",
            "Wittgenstein",
    ...
    },
    {
        ...
        image: "/hypatia.png",
        position: [
            -0.05205384694690418, -3.1835601741113986, 2.421205281431095,
        ].map((x) => x * scale),
        to: [],
        quote:
...

    {
        ...
        color: "aqua",
        image: "/boethius.png",
        position: [2.171209934493285, 0.3877924421053884, 3.336984333526845].map(
            (x) => x * scale_cassiopea
        ),
        to: [
            "Eriugena",
    ...
    },
    {
        ...
        current: "Realism",
        color: "yellow",
        image: "/adisankara.png",
        position: [2.0495146887471978, 0.08203187984493, 3.434058868350772].map(
            (x) => x * scale_cassiopea
        ),
    ...
    },
    {
        ...
        color: "yellow",
        image: "/alkindi.png",
        position: [1.8969212872420085, 0.4791876658743702, 3.4888492101095445].map(
            (x) => x * scale_cassiopea
        ),
        to: ["Roger Bacon"],
        quote:
    ...
    },
    {
        ...
        color: "aqua",
        image: "/eriugena.png",
        position: [1.8481792830635622, 0.7262478148581408, 3.4722899431165644].map(
            (x) => x * scale_cassiopea
        ),
    ...
    },
    {
        ...
        color: "yellow",
        image: "/alfarabi.png",
        position: [1.557696267517073, 0.8492365511033595, 3.585021564570212].map(
            (x) => x * scale_cassiopea
        ),
    ...
    },
    {
        ...
        color: "yellow",
        image: "/avicenna.png",
        position: [2.0818494459033365, 0.4528224095313625, 3.3853884193720196].map(
            (x) => x * scale_cassiopea
        ),
        to: [
            "Averroes",
    ...
    },
    {
        ...
        color: "aqua",
        image: "/anselm.png",
        position: [2.3263564158736303, 0.37857076743184237, 3.2318338447961183].map(
            (x) => x * scale_cassiopea
        ),
    ...
    },
    {
        ...
        color: "yellow",
        image: "/ramanuja.png",
        position: [1.0370408430556723, 0.6196517438580078, 3.813210983694465].map(
            (x) => x * scale_cassiopea
        ),
        to: ["Radhakrishnan"],
        quote:
    ...
    },
    {
        ...
        color: "yellow",
        image: "/alghazali.png",
        position: [1.8013680037173003, 0.26118459265243693, 3.561861300464201].map(
            (x) => x * scale_cassiopea
        ),
    ...
    },
    {
        ...
        color: "aqua",
        image: "/abelard.png",
        position: [2.176612216010103, 0.6977740314594266, 3.2826012036396452].map(
            (x) => x * scale_cassiopea
        ),
        to: ["John Salisbury"],
        quote:
    ...
    },
    {
        ...
        color: "yellow",
        image: "/averroes.png",
        position: [1.2232068209747387, 0.9307083623782575, 3.6929049564428347].map(
            (x) => x * scale_cassiopea
        ),
    ...
    },
    {
        ...
        color: "yellow",
        image: "/zhuxi.png",
        position: [2.6112117693914167, 0.5161458915032743, 2.985827609570927].map(
            (x) => x * scale_cassiopea
        ),
    ...
    },
    {
        ...
        color: "aqua",
        image: "/maimonide.png",
        position: [1.1274791750534303, 0.6638654349146379, 3.779956797920637].map(
            (x) => x * scale_cassiopea
        ),
    ...
    },
    {
        ...
        current: "Realism",
        color: "aqua",
        image: "/rogerbacon.png",
        position: [
            2.1485891757891022, -0.05266047807823887, 3.3735428599219657,
        ].map((x) => x * scale_cassiopea),
        to: [],
        quote:
    ...
    },
    {
        ...
        current: "Realism",
        color: "aqua",
        image: "/tomadaquino.png",
        position: [1.9869768184407013, 0.5015541564200336, 3.435166160632853].map(
            (x) => x * scale_cassiopea
        ),
    ...
    },
    {
        ...
        current: "Realism",
        color: "aqua",
        image: "/dunsscotus.png",
        position: [1.3864954227624784, 0.5456775843356003, 3.71212424584797].map(
            (x) => x * scale_cassiopea
        ),
...

    {
        ...
        current: "Realism",
        color: "aqua",
        image: "/nicolauscusanus.png",
        position: [2.299269509869404, 0.3208090014108861, 3.2573672352988785].map(
            (x) => x * scale_cassiopea
        ),
    ...
    },
    {
        ...
        current: "Realism",
        color: "yellow",
        image: "/machiavelli.png",
        position: [2.5009136087030046, 0.4642468794519191, 3.0870545762463077].map(
            (x) => x * scale_cassiopea
        ),
    ...
    },
    {
        ...
        color: "yellow",
        image: "/suarez.png",
        position: [2.49607990054025, -0.017280985113331288, 3.125585784724599].map(
            (x) => x * scale_cassiopea
        ),
    ...
    // <<<<<<<<<<<<<<<<<<<<<<<<<< Epoca Moderna Timpurie >>>>>>>>>>>>>>>>>>>>>>> 20

    {
        id: "Francis Bacon",
        current: "Realism",
        color: "aqua",
        image: "/francisbacon.png",
        position: [3.4930602719944344, 0.1278735838824578, 1.9447823227187213].map(
            (x) => x * scale_andromeda
        ),
    ...
    },
    {
        ...
        color: "aqua",
        image: "/hobbes.png",
        position: [3.1022139777110564, 0.9741077635215976, 2.3296743337945536].map(
            (x) => x * scale_andromeda
        ),
        to: [
            "Spinoza",
    ...
    },
    {
        ...
        color: "aqua",
        image: "/mersenne.png",
        position: [2.5354205423607237, 1.5219089936617651, 2.693591596435266].map(
            (x) => x * scale_andromeda
        ),
        to: ["Descartes"],
        quote:
    ...
    },
    {
        ...
        color: "aqua",
        image: "/gassendi.png",
        position: [3.383221409871801, 0.586309646797262, 2.0518415849810467].map(
            (x) => x * scale_andromeda
        ),
        to: ["Locke"],
    ...
    },
    {
        ...
        color: "aqua",
        image: "/descartes.png",
        position: [2.954347232894051, 0.55740865942724, 2.6383949692733255].map(
            (x) => x * scale_andromeda
        ),
        to: [
            "Arnauld",
    ...
    },
    {
        ...
        color: "aqua",
        image: "/arnauld.png",
        position: [2.4057542099261506, 1.0962597163671037, 3.0017597031896677].map(
            (x) => x * scale_andromeda
        ),
    ...
    },
    {
        ...
        color: "yellow",
        image: "/wangfuzi.png",
        position: [2.8628507202844053, -0.741438687332841, 2.6933908788538683].map(
            (x) => x * scale_andromeda
        ),
    ...
    },
    {
        ...
        color: "aqua",
        image: "/conway.png",
        position: [2.7422897845540275, -0.2693449454778268, 2.8995344519208897].map(
            (x) => x * scale_andromeda
        ),
        to: ["Leibniz"],
        quote:
    ...
    },
    {
        ...
        color: "aqua",
        image: "/spinoza.png",
        position: [3.0349768359193328, 0.7672861989873253, 2.490017569069877].map(
            (x) => x * scale_andromeda
        ),
    ...
    },
    {
        ...
        color: "aqua",
        image: "/locke.png",
        position: [3.5690326463215447, 0.747882697655651, 1.6439821896962081].map(
            (x) => x * scale_andromeda
        ),
        to: [
            "Berkeley",
    ...
    },
    {
        ...
        current: "Realism",
        color: "aqua",
        image: "/malebranche.png",
        position: [2.7364983129979925, 1.2298263212674776, 2.645582015828813].map(
            (x) => x * scale_andromeda
        ),
        to: [
            "Locke",
    ...
    },
    {
        ...
        image: "/leibniz.png",
        position: [
            2.8506652883700814, -0.24429633951395308, 2.7953580651111594,
        ].map((x) => x * scale_andromeda),
        to: [
            "Amo",
            "Kant",
            "Frege",
    ...
    },
    {
        ...
        color: "aqua",
        image: "/berkeley.png",
        position: [2.591702682338672, 0.8109734886841485, 2.9369029958461335].map(
            (x) => x * scale_andromeda
        ),
        to: ["Reid", "Hume", "Kant"],
        quote:
    ...
    },
    {
        ...
        current: "Realism",
        color: "aqua",
        image: "/montesquieu.png",
        position: [3.284080406548514, 0.5330912638442842, 2.2205021026193714].map(
            (x) => x * scale_andromeda
        ),
        to: ["Hume", "Burke", "Hegel"],
        quote:
...

    {
        ...
        color: "aqua",
        image: "/reid.png",
        position: [3.438608229682573, 0.5840408892116974, 1.9582823296164664].map(
            (x) => x * scale_andromeda
        ),
    ...
    },
    {
        ...
        color: "aqua",
        image: "/hume.png",
        position: [3.5567692660267163, 0.9067275667859221, 1.5897287529255604].map(
            (x) => x * scale_andromeda
        ),
        to: [
            "Reid",
    ...
    },
    {
        ...
        color: "aqua",
        image: "/rousseau.png",
        position: [3.1932997453467777, 0.25592413505944817, 2.395274425501654].map(
            (x) => x * scale_andromeda
        ),
    ...
    },
    {
        ...
        color: "aqua",
        image: "/kant.png",
        position: [2.9442760817008913, 0.6502215466385428, 2.6283931013094346].map(
            (x) => x * scale_andromeda
        ),
        to: [
            "Kierkgaard",
    ...
    },
    {
        ...
        color: "aqua",
        image: "/bentham.png",
        position: [2.5471915084383534, -0.5350519870391667, 3.037356546489889].map(
            (x) => x * scale_andromeda
        ),
...

    {
        ...
        image: "/hegel.png",
        position: [
            -1.3792623015003163, -3.305649696317612, -1.7805380054622066,
    ...
    },
    {
        ...
        image: "/mill.png",
        position: [
            -0.36654780120495106, -3.169049863093188, -2.4130407527973627,
        ].map((x) => x * scale_scorpio),
        to: [
            "James",
            "Frege",
    ...
    },
    {
        ...
        current: "Realism",
        color: "aqua",
        image: "/kierkgaard.png",
        position: [
            -0.28905226822034497, -2.911203213140891, -2.727882812372046,
        ].map((x) => x * scale_scorpio),
    ...
    },
    {
        ...
        image: "/marx.png",
        position: [
            -1.8414754151359922, -3.200274697599789, -1.5385740656050013,
        ].map((x) => x * scale_scorpio),
    ...
    },
    {
        ...
        color: "aqua",
        image: "/welby.png",
        position: [-0.991390308100662, -3.15247213222627, -2.2536780410122543].map(
            (x) => x * scale_scorpio
        ),
        to: ["Peirce", "Ogden"],
    ...
    },
    {
        ...
        image: "/peirce.png",
        position: [
            -0.23719705388456758, -3.0982024515940716, -2.5189043504200326,
        ].map((x) => x * scale_scorpio),
    ...
    },
    {
        ...
        image: "/nietzsche.png",
        position: [
            -0.40482473364926513, -3.156217683081648, -2.423717572661575,
        ].map((x) => x * scale_scorpio),
    ...
    },
    {
        ...
        color: "aqua",
        image: "/bradley.png",
        position: [-1.2648192506980491, -3.289931443402257, -1.89118570235098].map(
            (x) => x * scale_scorpio
        ),
    ...
    },
    {
        ...
        image: "/frege.png",
        position: [
            -1.8113973684760987, -3.101450308082711, -1.7606378275987151,
        ].map((x) => x * scale_scorpio),
        to: [
            "Husserl",
            "Russell",
...

    {
        ...
        color: "aqua",
        image: "/husserl.png",
        position: [3.2688031808341798, -2.2009847539270497, 0.6859969955830966].map(
            (x) => x * scale_pegasus
        ),
    ...
    },
    {
        ...
        color: "aqua",
        image: "/russell.png",
        position: [3.7483876639455964, -0.9213802516441403, 1.0491178926415534].map(
            (x) => x * scale_pegasus
        ),
        to: [
            "Carnap",
    ...
    },
    {
        ...
        color: "yellow",
        image: "/iqbal.png",
        position: [3.8539298205151296, 0.2228207752992496, 1.0476525381247643].map(
            (x) => x * scale_pegasus
        ),
        to: [],
        quote:
    ...
    },
    {
        ...
        position: [3.26311358795403, -1.1394956675282655, 2.013365176959732].map(
            (x) => x * scale_pegasus
        ),
        to: [],
        quote:
    ...
    },
    {
        ...
        position: [3.7002976884281487, -1.3201430488536188, 0.7516776886250982].map(
            (x) => x * scale_pegasus
        ),
        to: [
            "Carnap",
    ...
    },
    {
        ...
        color: "aqua",
        image: "/heidegger.png",
        position: [3.4685765446618415, -1.0936102519074062, 1.665230725979057].map(
            (x) => x * scale_pegasus
        ),
    ...
    },
    {
        ...
        color: "yellow",
        image: "/feng.png",
        position: [3.1844651437890468, -1.710934578794558, 1.7122746903104347].map(
            (x) => x * scale_pegasus
        ),
        to: [],
        quote:
    ...
    },
    {
        ...
        color: "aqua",
        image: "/popper.png",
        position: [2.9048401867473483, -2.3927459272105005, 1.3552381404296436].map(
            (x) => x * scale_pegasus
        ),
        to: ["Kuhn"],
        quote:
    ...
    },
    {
        ...
        color: "aqua",
        image: "/ayer.png",
        position: [3.71171073043422, -1.2294956358121767, 0.8435306367277271].map(
            (x) => x * scale_pegasus
        ),
        to: ["Strawson"],
        quote:
...

    {
        ...
        color: "aqua",
        image: "/strawson.png",
        position: [3.6290990710693207, -0.5524513197026951, 1.5888478441067104].map(
            (x) => x * scale_pegasus
        ),
    ...
    },
    {
        ...
        color: "aqua",
        image: "/anscombe.png",
        position: [2.906629763922843, -2.2313834413362827, 1.6038800931516315].map(
            (x) => x * scale_pegasus
        ),
        to: [],
        quote:
    ...
    },
    {
        ...
        color: "aqua",
        image: "/dummett.png",
        position: [3.6076434918831524, -0.6257909468803773, 1.6103708039689795].map(
            (x) => x * scale_pegasus
        ),
        to: [],
        quote:
    ...
    },
    {
        ...
        color: "red",
        image: "/wiredu.png",
        position: [3.199548904385861, -1.4695622417226062, 1.8982290763094076].map(
            (x) => x * scale_pegasus
        ),
        to: [],
        quote:
    ...
    },
    {
        ...
        color: "aqua",
        image: "/wiggins.png",
        position: [3.6686912398219347, -1.5599504001665436, 0.3275047112241811].map(
            (x) => x * scale_pegasus
        ),
        to: ["Nagel", "Kripke"],
        quote:
    ...
    },
    {
        ...
        color: "aqua",
        image: "/nagel.png",
        position: [3.7461943702340283, 0.23900295420135922, 1.3816314010291946].map(
            (x) => x * scale_pegasus
        ),
        to: [],
        quote:
    ...
    },
    {
        ...
        image: "/haack.png",
        position: [
            3.4989051158503073, -1.9061171855451646, 0.35267586428040104,
        ].map((x) => x * scale_pegasus),
        to: [],
        quote:
    ...
    },
    {
        ...
        color: "aqua",
        image: "/singer.png",
        position: [3.7959226848954826, -1.1023325600179283, 0.613052931988905].map(
            (x) => x * scale_pegasus
        ),
        to: [],
        quote:
